...
# =========================================================================
# Stateless helper functions — shared by BaseTable and ColumnProfile
# These do not depend on Tabulator-specific model state.
# =========================================================================
...
# processing to the stateless helpers above.
# =========================================================================
...
class ColumnProfile:
    ...
    def apply_to_model(state: ColumnProfileState, model: t.Any) -> None:
        ...
        # Set page_size and pagination mode BEFORE page, since page bounds
        # are computed from page_size via _update_max_page watcher.
